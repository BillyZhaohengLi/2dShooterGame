...
//class for object manipulation helper functions which represent combinations which appear so many times in the main game engine 
//that they deserve to be standalone helper methods.

/*
resets both players to opposite corners in the map, clear all shots in the level and reset the keys held.
